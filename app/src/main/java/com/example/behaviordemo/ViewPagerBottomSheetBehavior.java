...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    static final String TAG = "ViewPagerBehavior";
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        mMinOffset = Math.max(0, mParentHeight - childHeight);
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        return action == 2 && scroll != null && !this.mIgnoreEvents && this.mState != 1 && !parent.isPointInChildBounds(scroll, (int) event.getX(), (int) event.getY()) && mViewDragHelper != null && Math.abs(mInitialY - event.getY()) > (float) mViewDragHelper.getTouchSlop();
    ...
    public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V child, @NonNull View directTargetChild, @NonNull View target, int axes, int type) {
        Log.e(TAG, "ViewPagerBottomSheetBehavior onNestedScrollAccepted");
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target, int type) {
        Log.e(TAG,"ViewPagerBottomSheetBehavior onStopNestedScroll");
    ...
    public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, V child, View target,
        ...
        boolean result = target == mNestedScrollingChildRef.get() &&
                (mState != STATE_EXPANDED ||
                        super.onNestedPreFling(coordinatorLayout, child, target,
                                velocityX, velocityY));
        Log.e(TAG,"ViewPagerBottomSheetBehavior onNestedPreFling return:" + result);
        return result;
    }
    ...
    public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V child, @NonNull View target, float velocityX, float velocityY, boolean consumed) {
        boolean result = super.onNestedFling(coordinatorLayout, child, target, velocityX, velocityY, consumed);
        Log.e(TAG,"ViewPagerBottomSheetBehavior onNestedFling return:" + result);
        return result;
    }

    public boolean invalidateScrollingChild() {
        if (mViewRef != null) {
            View scrollingChild = findScrollingChild(mViewRef.get());
    ...
    View findScrollingChild(View view) {
        ...
        if (view instanceof ViewPager) {
            ...
            View currentViewPagerChild = null;
            if (viewPager.getAdapter() instanceof BaseFragmentPagerAdapter) {
                //自定义的adapter直接获取到选中view
                currentViewPagerChild = ((BaseFragmentPagerAdapter) viewPager.getAdapter()).getPrimaryItem();
            } else {
                //获取viewPager第一个子view
                currentViewPagerChild = viewPager.getChildAt(0);
            }
